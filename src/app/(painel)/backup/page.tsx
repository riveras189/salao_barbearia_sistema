...
import { getBackupRootDir, listBackups } from "@/lib/backup";
import {
  createBackupAction,
  deleteBackupAction,
    ...
    <div className="space-y-6 p-4 md:p-6 text-[var(--text)]">
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-[var(--muted)]">
              Faça backup do banco, baixe o arquivo SQL e restaure backups salvos
              do sistema.
            </p>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className={`${cardClass} p-5`}>
          ...
          <p className="mt-1 text-sm text-[var(--muted)]">
            Use esta opção para restaurar um backup vindo de outro computador.
          </p>
        ...
        <div className={`${cardClass} p-5`}>
          ...
          <div className="mt-3 space-y-2 text-sm text-[var(--muted)]">
            ...
            <p>• Os backups ficam salvos dentro da pasta informada acima.</p>
            <p>• Quando o backup tiver arquivos salvos junto, eles também são restaurados.</p>
            <p>• Antes de restaurar, é recomendado fazer um novo backup do estado atual.</p>
          </div>
        </div>
      </div>

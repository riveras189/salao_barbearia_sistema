...
export default async function ContasPagarPage({
  ...
  const erro = (params.erro || "").trim();

  const [fornecedores, contasRaw] = await Promise.all([
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-zinc-600">
          Controle de despesas, fornecedores e pagamentos.
        </p>
      </div>
      ...
      <form action={criarContaPagarAction} className={cardClass("grid gap-3")}>
        ...
        <input
          type="date"
          name="vencimento"
          className="max-w-xs rounded-xl border border-zinc-300 px-3 py-2 text-sm"
        />
                ...
                >
                  ...
                  <div className="flex flex-col gap-3 xl:flex-row xl:items-start xl:justify-between">
                    <div className="space-y-1">
                      ...
                      <div className="text-sm text-zinc-500">
                        Fornecedor: {conta.fornecedor?.nome || "Sem fornecedor"}
                      </div>
                      <div className="text-sm text-zinc-500">
                  ...
                  {podePagar && (
                    ...
                    >
                      ...
                      <input
                        ...
                        inputMode="decimal"
                        name="valor"
                        defaultValue={Number(conta.valorAberto).toFixed(2).replace(".", ",")}
                        required
                        className="rounded-xl border border-zinc-300 px-3 py-2 text-sm"
                      />

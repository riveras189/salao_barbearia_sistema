...
import type { BookingState } from "@/app/(site)/agendar/actions";
import { criarAgendamentoSiteAction } from "@/app/(site)/agendar/actions";
                    ...
                    {item.descricao ? (
                      <p
                        className={`mt-1 text-sm ${
                          ativo ? "text-slate-200" : "text-slate-700"
                        }`}
                      >
                        {item.descricao}
                      </p>
